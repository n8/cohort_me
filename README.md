...
* `:period` - Default is "weeks". Can also be "quarters", "months" or "days".
...
* `:start_from_interval` - Number of periods [days | weeks | months | quarters] before today to show the cohort analysis for. Defaults to 12. 
